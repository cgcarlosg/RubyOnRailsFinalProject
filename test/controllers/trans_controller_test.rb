...
class TransControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tran" do
    assert_difference('Tran.count') do
      post trans_url, params: { tran: { title: @tran.title, total: @tran.total, user_id: @tran.user_id } }
    end
  ...
  test "should update tran" do
    patch tran_url(@tran), params: { tran: { title: @tran.title, total: @tran.total, user_id: @tran.user_id } }
